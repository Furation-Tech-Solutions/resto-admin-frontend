...
const Admin = () => {
  ...
  const subscriptionend = new Date(
    JSON.parse(localStorage.getItem("admin")).subscriptionend
  );
  const piechartDate =
    Math.floor((subscriptionend - date) / (1000 * 60 * 60 * 24)) || 0;
  ...
  const handleSendMessageAddButton = () => {
    if (sendMessagePhoneNumber.length === 10) {
      setSendMessagePostData({
        ...sendMessagePostData,
        recipient: sendMessagePhoneNumber,
      });
    } else {
  ...
  const subscriptionData = useSelector(
    (store) => store.AppReducer.paymentHistory
  ).reverse();
  ...
  return (
    <div className="outerBoxAdmin">
      <div
        className={
          currentSubscriptionopen || isrequestAdmin
            ? "innerBoxAdminOverlay"
            : "innerBoxAdmin"
        }
      >
          ...
          <div className="ContentBoxSideBarrPhoneAdmin">
            <div className="leftsecondBoxAdmin">
              <div
                ...
                className={
                  barnum === 1
                    ? "leftsecondfirstAdminOn"
                    : "leftsecondfirstAdmin"
                }
              >
                <p>Dashboard</p>
              </div>
              ...
              >
                ...
                <div
                  className={
                    barnum === 2 || barnum === 3 || barnum === 4 || barnum === 5
                      ? "leftsecondseconddivAdmin"
                      : "leftsecondseconddivAdminOff"
                  }
                >
                  <p
                    className={
                      barnum === 2 || barnum === 3
                        ? "leftsendMessageAdmin"
                        : "leftsendMessageAdminOff"
                    }
                    onClick={() => setBarnum(3)}
                  >
                    Send Message
                    {(barnum === 2 || barnum === 3) && <AiOutlineCheck />}{" "}
                  </p>
                  <br />
                  <br />
                  <p
                    className={
                      barnum === 4
                        ? "leftsendBulkMessageAdmin"
                        : "leftsendBulkMessageAdminOff"
                    }
                    onClick={() => setBarnum(4)}
                  >
                    Bulk message{barnum === 4 && <AiOutlineCheck />}
                  </p>
                  <br />
                  <br />
                  <p
                    className={
                      barnum === 5
                        ? "leftannouncementAdmin"
                        : "leftannouncementAdminOff"
                    }
                    onClick={() => setBarnum(5)}
                  >
                    Announcement{barnum === 5 && <AiOutlineCheck />}
                  </p>
                  <br />
                  <br />
                </div>
              ...
              <div
                ...
                className={
                  barnum === 6
                    ? "leftsecondthirdAdminOn"
                    : "leftsecondthirdAdmin"
                }
              >
                <p>Feedback</p>
              </div>
            ...
            <div className="leftthirdBoxAdmin">
              <div
                onClick={() => setIsRequestAdmin(true)}
                className="leftthirdBoxfirstAdmin"
              >
                Request Support
              </div>
              <div
                onClick={() => handleLogout()}
                className="leftthirdBoxsecondAdmin"
              >
                <i className={isAuthLoading ? "fa fa-spinner fa-spin" : ""}></i>
                Logout
              </div>
            </div>
          </div>
        ...
        <div className="rightBoxAdmin">
            ...
            <div className="rightfirstBoxAdmin">
              ...
              <div className="countdownrightfirstBoxAdmin">
                ...
                <div className="countdownrightDoughnutOuterAdminFirstBox">
                  <div
                    onClick={() => setCurrentSubscriptionopen(true)}
                    className="countdownrightDoughnutInnerAdminFirstBox"
                  >
                    <Doughnut data={doughnutdata} />
                    <br />
                    <div className="countdownrightDoughnutInnerAdminNumberFirstBox">
                      {piechartDate}
                    </div>
                  </div>
                  <p className="countdownrightText">
                    {piechartDate}/30 days left
                  </p>
                </div>
              </div>
            </div>
              ...
              <input
                onChange={(e) => {
                  if (e.target.value.length <= 10) {
                    setSendMessagePhoneNumber(e.target.value);
                  }
                }}
                value={sendMessagePhoneNumber}
                type="text"
            ...
            <div className="sendMessageBoxAdminkeyboard">
              ...
              <div>
                <input
                  ...
                  value={sendMessagePostData.message}
                  type="text"
                ...
                <div className="dropZoneContainer">
                  <input
                    ...
                    accept=".jpg,.png"
                    onChange={(e) => handleSendMessageFile(e)}
                  />
                  <AiOutlinePaperClip
              ...
              <button
                onClick={() => handleSendMessageSendButton()}
                className="sendMessageBoxAdminkeyboardButtonText"
              >
                Send
              </button>
              <button
                onClick={() => handleSendMessageSendButton()}
                className="sendMessageBoxAdminkeyboardButtonImg"
              >
                <img src={send} alt="" />
              </button>
            </div>
          ...
          <div
            className={
              barnum === 4
                ? "sendBulkMessageBoxAdmin"
                : "sendBulkMessageBoxAdminOff"
            }
          >
            ...
            <div className="sendBulkMessageBoxAdminkeyboard">
              ...
              <button className="sendBulkMessageBoxAdminkeyboardButtonText">
                Send
              </button>
              <button className="sendBulkMessageBoxAdminkeyboardButtonImg">
                <img src={send} alt="" />
              </button>
            </div>
          </div>
          ...
          >
            ...
            <div className="announcementBoxAdminkeyboard">
              ...
              <button className="announcementBoxAdminkeyboardButtonText">
                Send
              </button>
              <button className="announcementBoxAdminkeyboardButtonImg">
                <img src={send} alt="" />
              </button>
            </div>
          </div>
                    ...
                    <tbody>
                      {feedbackData &&
                        feedbackData.map((feed, i) => {
                          return (
                            <tr key={i}>
                              <td className="FeedbackTableBodyAdmin">
                                {i + 1}
                              </td>
                              <td className="FeedbackTableBodyAdmin">
                                {feed.name}
          ...
          >
            <div className="rightSubscriptionBoxAdminInner">
              <p className="SubscriptionTextAdmin">
              ...
              {subscriptionData.length > 0 ? (
                  ...
                  <table className="SubscriptionTableAdmin">
                    <thead>
                      <tr>
                        ...
                        <th className="SubscriptionTableHeadAdmin">
                          Start Date
                        </th>
                    ...
                    <tbody>
                      {subscriptionData &&
                        subscriptionData.map((subscription, i) => {
                          return (
                            <tr key={i}>
                              <td className="SubscriptionTableBodyAdmin">
                                {i + 1}
                              </td>
                              <td className="SubscriptionTableBodyAdmin">
                              ...
                              <td
                                className={
                                  i === 0
                                    ? "SubscriptionTableBodyAdmintrue"
                                    : "SubscriptionTableBodyAdmin"
                                }
                              >
                                {i === 0 ? "Active" : "Expired"}
                              </td>
                ...
                <div className="notfounddiv">
                  <img
                    src={subscriptionandpayment}
                    alt="subscriptionandpayment"
                  />
        ...
        >
          <div className="navPhoneAdmin">
            <div className="menuIconAdminBox">
              <img
                onClick={() => setIsSidebarPhone(!isSidebarPhone)}
                src={menu}
                alt="menu"
              />
            </div>
          ...
          >
            <div className="firstBoxAdminPhone">
              ...
              <div
                onClick={() => setCurrentSubscriptionopen(true)}
                className="countdownrAdminBoxPhone"
              >
                <Doughnut data={doughnutdata} />
                <br />
                <div className="countdownrAdminBoxPhoneNumber">
                  {piechartDate}
                </div>
              </div>
            </div>
            ...
            <div className="sendMessageBoxAdminkeyboard">
              ...
              <div>
                <input
                  ...
                  value={sendMessagePostData.messsage}
                  type="text"
                  placeholder="Type message here..."
                />
                {/* <AiOutlinePaperClip size={"23px"} color="#878787"/> */}
          ...
          <div className="ContentBoxSideBarrPhoneAdmin">
            <div className="SecondBoxsideBarPhoneAdmin">
              ...
              >
                ...
                <div
                  className={
                    barnum === 2 || barnum === 3 || barnum === 4 || barnum === 5
                      ? "sidesecondseconddivPhoneAdmin"
                      : "sidesecondseconddivPhoneAdminOff"
                  }
                >
                  <p
                    className={
                      barnum === 2 || barnum === 3
                        ? "sidesendMessagePhoneAdmin"
                        : "sidesendMessagePhoneAdminOff"
                    }
                    onClick={() => {
                      setBarnum(3);
                      setIsSidebarPhone(!isSidebarPhone);
                  ...
                  <p
                    className={
                      barnum === 4
                        ? "sidesendBulkMessagePhoneAdmin"
                        : "sidesendBulkMessagePhoneAdminOff"
                    }
                    onClick={() => {
                      setBarnum(4);
                      setIsSidebarPhone(!isSidebarPhone);
                  ...
                  <p
                    className={
                      barnum === 5
                        ? "sideannouncementPhoneAdmin"
                        : "sideannouncementPhoneAdminOff"
                    }
                    onClick={() => {
                      setBarnum(5);
                      setIsSidebarPhone(!isSidebarPhone);
              ...
              <div
                ...
                className={
                  barnum === 6
                    ? "sidesecondthirdPhoneAdminOn"
                    : "sidesecondthirdPhoneAdmin"
                }
              >
                <p>Feedback</p>
              </div>
            ...
            <div className="ThirdBoxsideBarPhoneAdmin">
              <div
                ...
                className="ThirdBoxsideBarFirstPhoneAdmin"
              >
                Request Support
              </div>
              <div
      ...
      {isSubscribed === true && (
        <div
          className={
            currentSubscriptionopen
              ? "currentSubscriptionAdmin"
              : "currentSubscriptionAdminOff"
          }
        >
          <div className="currentSubscriptionCloseAdmin">
            <img
              onClick={() => setCurrentSubscriptionopen(false)}
              src={closeicon}
              alt=""
            />
          </div>
          ...
          <div className="currentSubscriptionInnerBoxAdmin">
            <div className="currentSubscriptionDoughnutOuterAdmin">
              <div className="currentSubscriptionDoughnutInnerAdmin">
                <Doughnut data={doughnutdata} />
                <br />
                <div className="currentSubscriptionDoughnutInnerAdminNumber">
                  {piechartDate}
                </div>
              </div>
            ...
            <div className="currentSubscriptionTextBoxAdmin">
              ...
              <p>
                End Date :-{" "}
                {new Date(adminDetails.subscriptionend).toLocaleDateString()}
              </p>
            </div>
            <div
              className="currentSubscriptionviewallAdmin"
              onClick={() => {
                setBarnum(7);
      ...
      {isSubscribed === false && (
        ...
        >
          ...
          <p className="newSubscriptionTextAdmin">
          ...
          <div className="newSubscriptionInnerBoxAdmin">
            ...
            <div className="newSubscriptionbenifitsBoxAdmin">
              <div>
                ...
                <p>
                  Premium Membership-{" "}
                  <span>Unlock Exclusive Benefits Every Month</span>
                </p>
              </div>
              <div>
                <img src={checkcircle} alt="" />
                <p>
                  ...
                  <span>Your Gateway to Ongoing Rewards</span>
                </p>
              </div>
              <div>
                <img src={checkcircle} alt="" />
            ...
            <button className="newSubscriptionsubscribebuttonAdmin">
              Subscribe
            </button>
          </div>
        </div>
      ...
      <div
        className={
          isrequestAdmin ? "requestSupportAdmin" : "requestSupportAdminOff"
        }
      >
        <div className="requestSupportCloseAdmin">
          <img
            onClick={() => setIsRequestAdmin(false)}
            src={closeicon}
            alt=""
          />
        </div>
        ...
        <div className="requestSupporttextBox">
          <textarea
            onChange={(e) => setRequestSupportValue(e.target.value)}
            value={requestSupportValue}
            className="requestSupportInput"
            type="text"
