...
const SingleAdmin = () => {
  ...
  useEffect(() => {
    if (
      getSingleAdminData({
        adminId: location.pathname.split("/")[2].split(":")[1],
      })
    )
      dispatch(
        getSingleAdminData({
        ...
        <div className="rightBoxSingleAdmin">
          ...
          >
            ...
            <div className="rightSubscriptionBoxSingleAdminInner">
              <p className="SubscriptionTextSingleAdmin">
                Subscription & Payment History
              </p>
              {subscriptionData.length > 0 ? (
                <div className="subscriptiontableholderSingleAdmin">
                  <table className="SubscriptionTableAdmin">
                    <thead>
                      <tr>
                        <th className="SubscriptionTableHeadSingleAdmin">
                          Sr. No.
                        </th>
                        <th className="SubscriptionTableHeadSingleAdmin">
                          Plan
                    ...
                    <tbody>
                      {subscriptionData &&
                        subscriptionData.map((subscription, i) => {
                          return (
                            <tr key={i}>
                              <td className="SubscriptionTableBodySingleAdmin">
                                {i + 1}
                              </td>
                              <td className="SubscriptionTableBodySingleAdmin">
                              ...
                              <td
                                className={
                                  i === 0
                                    ? "SubscriptionTableBodySingleAdmintrue"
                                    : "SubscriptionTableBodySingleAdmin"
                                }
                              >
                                {i === 0 ? "Active" : "Expired"}
                              </td>
