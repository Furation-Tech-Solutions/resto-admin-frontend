    ...
    <div className="rightsecondBoxAdmin">
      <div className="rightsecondBoxCount">
        ...
        <div className="rightsecondBoxCountOuter">
          ...
          <div className="rightsecondBoxCountNumber">
      ...
      <div className="AdminTabChartWrapper">
        <div
          className={
            chartnumphone === 1 ? "weeklyChartAdmin" : "weeklyChartAdminHide"
          }
        >
        ...
        <div
          className={
            chartnumphone === 2 ? "monthlyChartAdmin" : "monthlyChartAdminHide"
          }
        >
